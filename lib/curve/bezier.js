Bezier = (() => {
        ...
        h = {
            ...
            compute: function(c, n, e) {
                ...
                if (i < 4) {
                    let u = s * s,
                        f = c * c,
                        l, y, a, x = 0;
                    i === 2 ? (o = [o[0], o[1], o[2], tt], l = u, y = s * c * 2, a = f) : i === 3 && (l = u * s, y = u * c * 3, a = s * f * 3, x = c * f);
                    let p = {
                ...
                for (; r.length > 1;) {
                    for (let u = 0; u < r.length - 1; u++) r[u] = {
                        x: r[u].x + (r[u + 1].x - r[u].x) * c,
                        y: r[u].y + (r[u + 1].y - r[u].y) * c
                    }, typeof r[u].z != "undefined" && (r[u].z = r[u].z + (r[u + 1].z - r[u].z) * c);
            ...
            length: function(c) {
                let n = .5,
                    e = h.Tvalues.length,
                    i = 0;
                for (let s = 0, o; s < e; s++) o = n * h.Tvalues[s] + n, i += h.Cvalues[s] * h.arcfn(o, c);
                return n * i
            },
            ...
            abcratio: function(c, n) {
                if (n !== 2 && n !== 3) return !1;
                if (typeof c == "undefined") c = .5;
                else if (c === 0 || c === 1) return c;
                let e = T(c, n) + T(1 - c, n),
                    i = e - 1;
                return J(i / e)
            },
            ...
            makeline: function(c, n) {
                return new v(c.x, c.y, (c.x + n.x) / 2, (c.y + n.y) / 2, n.x, n.y)
            },
            findbbox: function(c) {
                let n = Y,
                    e = Y,
            ...
            getminmax: function(c, n, e) {
                ...
                for (let u = 0, f = e.length; u < f; u++) o = e[u], r = c.get(o), r[n] < i && (i = r[n]), r[n] > s && (s = r[n]);
                return {
                    min: i,
                    mid: (i + s) / 2,
                    max: s,
            ...
            roots: function(c, n) {
                ...
                if (O < 0) {
                    let d = -p / 3,
                        ...
                        R = D(A),
                        I = 2 * R;
                    return S = I * N(C / 3) - y / 3, m = I * N((C + W) / 3) - y / 3, E = I * N((C + 2 * W) / 3) - y / 3, [S, m, E].filter(s)
                } else {
                    if (O === 0) return M = q < 0 ? D(-q) : -D(q), S = 2 * M - y / 3, m = -M - y / 3, [S, m].filter(s);
                    {
                        let d = F(O);
                        return M = D(-q + d), w = D(q + d), [M - w - y / 3].filter(s)
                    }
                }
            },
            droots: function(c) {
            ...
            curvature: function(c, n, e, i, s) {
                ...
                if (l = o / r, y = r / o, !s) {
                    let g = h.curvature(c - .001, n, e, i, !0).k,
            ...
            bboxoverlap: function(c, n) {
                ...
                for (let s = 0, o, r, u, f; s < i; s++)
                    if (o = e[s], r = c[o].mid, u = n[o].mid, f = (c[o].size + n[o].size) / 2, J(r - u) >= f) return !1;
                return !0
            },
    ...
    var v = class {
        constructor(n) {
            let e = n && n.forEach ? n : Array.from(arguments).slice(),
                i = !1;
            ...
            let r = this._3d = !s && (o === 9 || o === 12) || n && n[0] && typeof n[0].z != "undefined",
                u = this.points = [];
            ...
            let a = h.align(u, {
                ...
                x = h.dist(u[0], u[l]);
            this._linear = a.reduce((p, g) => p + G(g.y), 0) < x / 50, this._lut = [], this._t1 = 0, this._t2 = 1, this.update()
        }
        static quadraticFromPoints(n, e, i, s) {
            if (typeof s == "undefined" && (s = .5), s === 0) return new v(e, e, i);
            if (s === 1) return new v(n, e, e);
            let o = v.getABC(2, n, e, i, s);
            return new v(n, o.A, i)
        }
        static cubicFromPoints(n, e, i, s, o) {
            typeof s == "undefined" && (s = .5);
            let r = v.getABC(3, n, e, i, s);
        ...
        toSVG() {
            ...
            for (let o = 1, r = n.length; o < r; o++) s.push(n[o].x), s.push(n[o].y);
            return s.join(" ")
        }
        setRatios(n) {
        ...
        static getABC(n = 2, e, i, s, o = .5) {
            let r = h.projectionratio(o, n),
                u = 1 - r,
                f = {
                    x: r * e.x + u * s.x,
                    y: r * e.y + u * s.y
        ...
        getLUT(n) {
            ...
            for (let e = 0, i, s; e < n; e++) s = e / (n - 1), i = this.compute(s), i.t = s, this._lut.push(i);
            return this._lut
        }
        on(n, e) {
            e = e || 5;
            let i = this.getLUT(),
                s = [];
            for (let o = 0, r, u = 0; o < i.length; o++) r = i[o], h.dist(r, n) < e && (s.push(r), u += o / i.length);
        ...
        project(n) {
            let e = this.getLUT(),
                ...
                x;
            l += 1;
            for (let p; y < u + f; y += f) x = this.compute(y), p = h.dist(n, x), p < l && (l = p, a = y);
        ...
        raise() {
            let n = this.points,
                e = [n[0]],
                i = n.length;
            for (let s = 1, o, r; s < i; s++) o = n[s], r = n[s - 1], e[s] = {
                x: (i - s) / i * o.x + s / i * r.x,
                y: (i - s) / i * o.y + s / i * r.y
            };
        ...
        __normal3(n) {
            ...
            r.x /= u, r.y /= u, r.z /= u;
            let f = [r.x * r.x, r.x * r.y - r.z, r.x * r.z + r.y, r.x * r.y + r.z, r.y * r.y, r.y * r.z - r.x, r.x * r.z - r.y, r.y * r.z + r.x, r.z * r.z];
            return {
                t: n,
        ...
        hull(n) {
            ...
            for (s[o++] = e[0], s[o++] = e[1], s[o++] = e[2], this.order === 3 && (s[o++] = e[3]); e.length > 1;) {
                i = [];
                for (let r = 0, u, f = e.length - 1; r < f; r++) u = h.lerp(n, e[r], e[r + 1]), s[o++] = u, i.push(u);
                e = i
            }
            return s
        }
        ...
        simple() {
            if (this.order === 3) {
                let s = h.angle(this.points[0], this.points[3], this.points[1]),
        ...
        translate(n, e, i) {
            ...
            let s = this.order,
                o = this.points.map((r, u) => (1 - u / s) * e + u / s * i);
            return new v(this.points.map((r, u) => ({
                x: r.x + n.x * o[u],
                y: r.y + n.y * o[u]
            })))
        }
        ...
        outlineshapes(n, e, i) {
            e = e || n;
            let s = this.outline(n, e).curves,
                o = [];
            for (let r = 1, u = s.length; r < u / 2; r++) {
                let f = h.makeshape(s[r], s[u - r], i);
                f.startcap.virtual = r > 1, f.endcap.virtual = r < u / 2 - 1, o.push(f)
            }
            return o
        }
        intersects(n, e) {
            return n ? n.p1 && n.p2 ? this.lineIntersects(n) : (n instanceof v && (n = n.reduce()), this.curveintersects(this.reduce(), n, e)) : this.selfintersects(e)
        }
        lineIntersects(n) {
            let e = V(n.p1.x, n.p2.x),
                i = V(n.p1.y, n.p2.y),
                s = H(n.p1.x, n.p2.x),
                o = H(n.p1.y, n.p2.y);
        ...
        selfintersects(n) {
            let e = this.reduce(),
                i = e.length - 2,
                s = [];
            for (let o = 0, r, u, f; o < i; o++) u = e.slice(o, o + 1), f = e.slice(o + 2), r = this.curveintersects(u, f, n), s.push(...r);
            return s
        }
        curveintersects(n, e, i) {
            ...
            return s.forEach(function(r) {
                let u = h.pairiteration(r.left, r.right, i);
        ...
        _iterate(n, e) {
            ...
            do {
                ...
                let r = this.get(i),
                    ...
                    q = 0;
                do
                    if (x = a, y = l, g = (i + s) / 2, q++, u = this.get(g), f = this.get(s), l = h.getccenter(r, u, f), l.interval = {
                            start: i,
                            end: s
