...
(function () {
  ...
  class ZPixelRectBrush extends DecorationUtils.createDecoratorClass(fabric.PencilBrush, {
    ...
    updateDict_zPixelRect: function() {
      ...
      logger.log("logZPixelSel", "trueSize__zPixel:", trueSize__zPixel);
    ...
    getDict_zPixel: function(pointer) {
      ...
      const dict_zPixel = this.fabricIntegration.createDict__zPixel__forZPixelBrushPointerAndHomeScale(pointer, this.homeScale);
    ...
    createFZPixelRect_p: function(dict_zPixelRect) {
      ...
      const fObj_p = this.fabricIntegration.createFabricZPixelRectWith__dict_zPixelRect_p(dict_zPixelRect);
    ...
    _finalizeAndAddZPixelRect: function () {
      ...
      .then((fObj__zPixelRect) => {

        this.canvas.clearContext(ctx);
        this.canvas.fire('before:zPixelRect:created', { zPixelRect: fObj__zPixelRect });
        ...
        this.canvas.fire('zPixelRect:created', { zPixelRect: fObj__zPixelRect });
    ...
    _setBrushStyles: function (ctx) {
      // logger.log("logZPixelRectBrush", "_setBrushStyles", "ctx:", ctx, "this:", this);
