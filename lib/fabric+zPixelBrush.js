...
(function () {
  ...
  class ZPixelBrush extends DecorationUtils.createDecoratorClass(fabric.ZIndexPencilBrush, {
    ...
    createFZPixelGroup_p: async function(arr_dict_zPixel) {
      ...
      const zLevel = Object.values(dict_zLevel).find(e => true);
  ...
  ZPixelBrush.createInstance = function(fabricCanvas) {
    ...
    const brush__zPencil = fabric.ZIndexPencilBrush.createInstance(fabricCanvas);
