...
(function () {
  ...
  class ZPixelBrush extends DecorationUtils.createDecoratorClass(fabric.PencilBrush, {
    ...
    createFZPixelGroup: function(arr_dict_zPixel) {
    ...
    _finalizeAndAddZPixelPath: function () {
      ...
      {
        var fObj_group_zPixel = this.createFZPixelGroup(this.arr_dict_zPixel);
        this.canvas.clearContext(ctx);
        this.canvas.fire('before:zPixelGroup:created', { zPixelGroup: fObj_group_zPixel });
        ...
        this.canvas.fire('zPixelGroup:created', { zPixelGroup: fObj_group_zPixel });
      }
