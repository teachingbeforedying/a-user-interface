...
(function () {
  ...
  class ZCombPencilBrush extends DecorationUtils.createDecoratorClass(fabric.CombPencilBrush, {
    ...
    addBrush: function(brush_in) {
      ...
      //deactivate some of ZIndexPencilBrush decoration
      const isZIndexPencilBrush = DecorationUtils.isOfficiallyDecorated_with_class(brush_in, fabric.ZIndexPencilBrush);
      // logger.log("logZComb", "isZIndexPencilBrush:", isZIndexPencilBrush);
      if(isZIndexPencilBrush) {
        DecorationUtils.setIsDecorationActive__updateDecorationConfig_in_decorator(brush_in, fabric.ZIndexPencilBrush, {
          onMouseDown: false,
          onMouseMove: false,
        });
      }
      ...
      //debug
      // logger.log("logFDZ", "getDecorationConfigDict__for_decorator", DecorationUtils.getDecorationConfigDict__for_decorator(brush_in, fabric.ZIndexPencilBrush));
