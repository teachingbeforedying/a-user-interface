...
(function () {
  ...
  class ZCombPencilBrush extends DecorationUtils.createDecoratorClass(fabric.CombPencilBrush, {
    ...
    zIndexWrapAround: function(arr_dict_brushAndFunc) {
      ...
      
      {
        ...
        arr_interval.forEach(([dict_from, dict_to]) => {
          //call brush func
          dict_from.func(dict_from.brush);
        ...
        dict_brushAndFunc__last.func(dict_brushAndFunc__last.brush);
      }
    ...
    _render: function(ctx) {
      ...
      this.zIndexWrapAround(arr_dict_brushAndFunc);
